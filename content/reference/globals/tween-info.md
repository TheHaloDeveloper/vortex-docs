...
`TweenInfo` is an immutable Luau data structure that defines the playback parameters for a `Tween` created via [`TweenService`](https://create.roblox.com/docs/reference/engine/classes/TweenService). 
